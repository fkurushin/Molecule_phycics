...
class AtomicEnergy(object):
    """
    Класс, в котором реализован способ рассчета энергии взаимодействия атома
    """
...
def main():
    PATH = "/Users/magomednikolaev/Documents/Вычислительные_и_инф_технологии/Structure_optimization/SiMolecule.xyz"

    AE = AtomicEnergy(filepath=PATH,
                      D0=3.24,
                      r0=2.222,
                      S=1.57,
                      Betta=1.4760,
